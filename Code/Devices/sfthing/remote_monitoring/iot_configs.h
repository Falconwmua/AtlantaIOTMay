 ...
 * WiFi setup
 */
#define IOT_CONFIG_WIFI_SSID            "<SSID-CHANGEME>"
#define IOT_CONFIG_WIFI_PASSWORD        "<SSID-PASSWORD-CHANGEME>"
 ...
 */
#define IOT_CONFIG_CONNECTION_STRING    "<IOTHUB-DEVICE-CONNECTION-STRING-CHANGEME>"
